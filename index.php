...
<link rel="stylesheet" type="text/css"
	...
	<div class="destinations-section py-5" style="background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%);">
		<div class="container">
			<h2 class="text-center mb-4" style="color: #fff; font-family: 'product sans'; font-size: 2.5rem;">Popular Destinations</h2>
			<div class="row g-4">
				<div class="col-md-4">
					<div class="destination-card">
						<div class="card-img">
							<img src="assets/images/destinations/paris.jpg" alt="Paris" class="img-fluid">
						</div>
						<div class="card-content p-3">
							<h3 style="color: #fff;">Paris, France</h3>
							<p style="color: #b3b3b3;">The City of Light, known for its art, fashion, and culture</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="destination-card">
						<div class="card-img">
							<img src="assets/images/destinations/tokyo.jpg" alt="Tokyo" class="img-fluid">
						</div>
						<div class="card-content p-3">
							<h3 style="color: #fff;">Tokyo, Japan</h3>
							<p style="color: #b3b3b3;">A vibrant mix of traditional and modern culture</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="destination-card">
						<div class="card-img">
							<img src="assets/images/destinations/newyork.jpg" alt="New York" class="img-fluid">
						</div>
						<div class="card-content p-3">
							<h3 style="color: #fff;">New York, USA</h3>
							<p style="color: #b3b3b3;">The city that never sleeps, full of iconic landmarks</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="destination-card">
						<div class="card-img">
							<img src="assets/images/destinations/dubai.jpg" alt="Dubai" class="img-fluid">
						</div>
						<div class="card-content p-3">
							<h3 style="color: #fff;">Dubai, UAE</h3>
							<p style="color: #b3b3b3;">A futuristic city with stunning architecture</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="destination-card">
						<div class="card-img">
							<img src="assets/images/destinations/sydney.jpg" alt="Sydney" class="img-fluid">
						</div>
						<div class="card-content p-3">
							<h3 style="color: #fff;">Sydney, Australia</h3>
							<p style="color: #b3b3b3;">Beautiful beaches and iconic Opera House</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="destination-card">
						<div class="card-img">
							<img src="assets/images/destinations/london.jpg" alt="London" class="img-fluid">
						</div>
						<div class="card-content p-3">
							<h3 style="color: #fff;">London, UK</h3>
							<p style="color: #b3b3b3;">Historic landmarks and royal heritage</p>
						</div>
					</div>
				</div>
			</div>
